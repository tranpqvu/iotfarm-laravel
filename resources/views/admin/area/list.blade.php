...
<div class="container-fluid" style="background-color: #fff; padding: 1em;">
    <div class="container">
        <h4 style="text-align:center; color:#0090d2; font-weight: bold;">Danh Sách Khu Vực</h4>
    </div>
    <br/>
            ...
            <table id="grid-data" class="table table-condensed table-hover table-striped">
                <thead>
                    <tr>
                        ...
                        <th data-column-id="name" >Tên Khu Vực</th>
...
function process_action_add(){
    window.location.href = "{{ url('admin/area/create') }}";
}
