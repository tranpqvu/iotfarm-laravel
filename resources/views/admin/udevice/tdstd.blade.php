...
<div class="container-fluid" style="background-color: #fff; padding: 1em;">
        <h4 style="text-align:center; color:#0090d2; font-weight: bold;">TDS Tự Động</h4>
        <div class="btn-group">
            <button type="button" class="btn btn-primary" onclick="saveControl({!!$id!!},0,1)">Thủ Công</button>
