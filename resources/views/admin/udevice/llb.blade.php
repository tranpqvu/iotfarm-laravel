...
<div class="container-fluid" style="background-color: #fff; padding: 1em;">
        <h4 style="text-align:center; color:#0090d2; font-weight: bold;">Lưu Lượng Bơm</h4><br>
        <table style="width: 100%; border: 1px solid; text-align:center;">
            ...
            <tr>
                <td><button class="button buttonOn">On</button></td>
                <td><button class="button buttonOn">On</button></td>
                <td><button class="button buttonOn">On</button></td>
                <td><button class="button buttonOn">On</button></td>
                <td><button class="button buttonOn">On</button></td>
            ...
            <tr>
                <td><button class="button buttonOff">Off</button></td>
                <td><button class="button buttonOff">Off</button></td>
                <td><button class="button buttonOff">Off</button></td>
                <td><button class="button buttonOff">Off</button></td>
                <td><button class="button buttonOff">Off</button></td>
