...
<div class="container-fluid" style="background-color: #fff; padding: 1em;">
        <h4 style="text-align:center; color:#0090d2; font-weight: bold;">TL Thủ Công</h4>
        <div class="btn-group">
            <button type="button" class="btn btn-primary active">Thủ Công</button>
            <button type="button" class="btn btn-primary" onclick="saveControl({!!$id!!},1,0)">Tự Động</button>
