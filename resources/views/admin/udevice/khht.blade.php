...
<div class="container-fluid" style="background-color: #fff; padding: 1em;">
    <div class="container">
        <h4 style="text-align:center; color:#0090d2; font-weight: bold;"></h4>
        <table class="styled-table">
        <caption style="caption-side:top;">KHÍ HẬU HIỆN TẠI</caption>
            <thead>
                <tr>
                <th>NAME</th>
                <th>TRẠM 1</th>
        ...
        <table class="styled-table">
            <caption style="caption-side:top;">KHÍ HẬU TRONG NGÀY</caption>
            <thead>
            <tr>
                <th>NAME</th>
                <th>TRẠM 1</th>
