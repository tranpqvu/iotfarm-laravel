...
<div class="container-fluid" style="background-color: #fff; padding: 1em;">
        <h4 style="text-align:center; color:#0090d2; font-weight: bold;">TDS Thủ Công</h4>
        <div class="btn-group">
            <button type="button" class="btn btn-primary active">Thủ Công</button>
            <button type="button" class="btn btn-primary"  onclick="saveControl({!!$id!!},0,0)">Tự Động</button>
        ...
        <br><div>Nhập Nồng Độ Dinh Dưỡng (ppm) <input type="text" value="0"></div>
        <br><div>Chọn Bơm Hoạt Động</div>
        <table style="width: 100%; border: 1px solid; text-align:center;">
            <tr>
                <td><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
        <label for="vehicle1"> <b>1</b></label></td>
                <td><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
        <label for="vehicle1"> <b>2</b></label></td>
        <td><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
        <label for="vehicle1"> <b>3</b></label></td>
        <td><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
        <label for="vehicle1"> <b>4</b></label></td>
        <td><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
        <label for="vehicle1"> <b>5</b></label></td>
        <td><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
        <label for="vehicle1"> <b>6</b></label></td>
        <td><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
        <label for="vehicle1"> <b>7</b></label></td>
        <td><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
        <label for="vehicle1"> <b>8</b></label></td>
            </tr>
        </table>
        <br><div>Tắt sau <input type="text" value="0"> phút</div>
        <br><div><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
        <label for="vehicle1"> Chuyển sang tự động</label><br></div>
