...
<div class="container-fluid" style="background-color: #fff; padding: 1em;">
    <div class="container">
        <h4 style="text-align:center; color:#0090d2; font-weight: bold;">Danh Sách Nông Trại</h4>
    </div>
    <br/>
...
function process_action_add(){
    window.location.href = "{{ url('admin/farm/create') }}";
