...
<div class="row justify-content-center">
    <div class="col-md-6">
        <p><a class="btn btn-primary" href="{{ url('admin/ql-lop-hoc/'.$class_id.'/ds-hoc-sinh') }}">Về danh sách</a></p>
        <div class="card">
            <div class="card-header">
                <h4>Cập nhật thông tin Học Sinh</h4>
            </div>
            <div class="card-body">
                <div class="col-xs-4 col-xs-offset-4">
                    <form action="{{ url('admin/ql-lop-hoc/'. $getDataById[0]->id.'/cap-nhat-hs/' . $class_id) }}" method="post" enctype="multipart/form-data">
