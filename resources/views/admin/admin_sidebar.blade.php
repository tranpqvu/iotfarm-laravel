   ...
   <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
       ...
       <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/admin') }}">
           ...
           <div class="sidebar-brand-text mx-3">IOT Farm</div>
       </a>
       ...
       <!--li class="nav-item">
           <a class="nav-link" href="{{ url('admin/udevice/') }}">
       ...
       <li class="nav-item">
           <a class="nav-link" href="{{ url('admin/udevice/') }}">
               <i class="fa fa-server" aria-hidden="true"></i>
               <span>Thông Tin Thiết Bị</span></a>
       </li>
       <li class="nav-item">
           <a class="nav-link" href="{{ url('admin/udevice/htcp') }}">
               <i class="fa fa-server" aria-hidden="true"></i>
               <span>Chọn Hình Thức Châm Phân</span></a>
       </li-->
       <!--li class="nav-item">
           <a class="nav-link" href="{{ url('admin/udevice/tltc') }}">
               <i class="fa fa-server" aria-hidden="true"></i>
               <span>TL Thủ Công</span></a>
       </li> 
       <li class="nav-item">
           <a class="nav-link" href="{{ url('admin/udevice/tltd') }}">
               <i class="fa fa-server" aria-hidden="true"></i>
               <span>TL Tự Động</span></a>
       </li> 
       <li class="nav-item">
           <a class="nav-link" href="{{ url('admin/udevice/tdstc') }}">
               <i class="fa fa-server" aria-hidden="true"></i>
               <span>TDS Thủ Công</span></a>
       </li> 
       <li class="nav-item">
           <a class="nav-link" href="{{ url('admin/udevice/tdstd') }}">
               <i class="fa fa-server" aria-hidden="true"></i>
               <span>TDS Tự Động</span></a>
       </li>
       <li class="nav-item">
           <a class="nav-link" href="{{ url('admin/udevice/httl') }}">
               <i class="fa fa-server" aria-hidden="true"></i>
               <span>Hiển Thị TL</span></a>
       </li> 
       <li class="nav-item">
           <a class="nav-link" href="{{ url('admin/udevice/httds') }}">
               <i class="fa fa-server" aria-hidden="true"></i>
               <span>Hiển Thị TDS</span></a>
       </li-->
       <!--li class="nav-item">
           <a class="nav-link" href="{{ url('admin/udevice/lsttn') }}">
               <i class="fa fa-server" aria-hidden="true"></i>
               <span>Lịch Sử Tưới Trong Ngày</span></a>
       </li-->
       <!--li class="nav-item">
           <a class="nav-link" href="{{ url('admin/udevice/llb') }}">
               <i class="fa fa-server" aria-hidden="true"></i>
               <span>Lưu Lượng Bơm</span></a>
       </li-->
       <!--li class="nav-item">
           <a class="nav-link" href="{{ url('admin/udevice/khht') }}">
               <i class="fa fa-server" aria-hidden="true"></i>
               <span>Khí Hậu Hiện Tại</span></a>
       </li-->
       <!-- Heading -->
      {{--  <div class="sidebar-heading">
           Addons
