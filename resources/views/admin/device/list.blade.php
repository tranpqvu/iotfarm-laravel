...
<div class="container-fluid" style="background-color: #fff; padding: 1em;">
    <div class="container">
        <h4 style="text-align:center; color:#0090d2; font-weight: bold;">Danh Sách Thiết Bị</h4>
    </div>
    <br/>
            ...
            <table id="grid-data" class="table table-condensed table-hover table-striped">
                <thead>
                    <tr>
                        ...
                        <th data-column-id="name" >Tên Thiết Bị</th>
                        <th data-column-id="mac">MAC Address</th>
                        <th data-column-id="farm_name">Nông Trại</th>
                        <!--th data-column-id="email">User</th-->
    ...
    $(document).ready(function(){
        ...
        var grid = $("#grid-data").bootgrid({
            ...
            formatters : {
                ...
                {	              
                    return  "<button title='Điều Khiển Thiết Bị' type=\"button\" class=\"bootgrid-btn btn-xs btn-default command-control\" data-row-id=\"" + row.id + "\"><span class=\"fa fa-wrench \"></span></button>"+
        ...
        $("#grid-data .command-control").on("click", function(e)
        {
            location.href='admin/udevice/'+$(this).data("row-id")+'/tttb';
        });
