                    ...
                    <div class="col-xs-4 col-xs-offset-4">
                        <form method="POST" action="{{ url('admin/farm/create') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="name" class="lbl_form">Tên Thiết Bị</label>
                                <input type="text" class="form-control" id="name" name="name" placeholder="name"
                                    maxlength="255" required value="@php echo Session::has('data')? Session::get('data')["name"] : ""; @endphp" />
                            </div>
                            <div class="form-group">
                                <label for="phone" class="lbl_form">MAC Address</label>
                                <input type="text" class="form-control" id="mac" name="mac" placeholder="XXXXXXXX"
                                    maxlength="255" required value="@php echo Session::has('data')? Session::get('data')["mac"] : ""; @endphp" />
                            </div>
                            <div class="form-group">
