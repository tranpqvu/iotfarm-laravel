!function(e) {
    ...
    function i(i, p) {
        ...
        function f() {
            ...
            }).addClass("btn").attr("data-action", "incrementHours").append($("<i>").addClass(p.icons.up)))), 
            ...
            }).addClass("btn").attr("data-action", "decrementHours").append($("<i>").addClass(p.icons.down))))), 
            ...
            }).addClass("btn").attr("data-action", "incrementMinutes").append($("<i>").addClass(p.icons.up)))), 
            ...
            }).addClass("btn").attr("data-action", "decrementMinutes").append($("<i>").addClass(p.icons.down))))), 
            d("s") && (d("m") && (e.append($("<td>").addClass("separator")), t.append($("<td>").addClass("separator").html(":")), 
            a.append($("<td>").addClass("separator"))), e.append($("<td>").append($("<a>").attr({
                href: "#",
                tabindex: "-1",
                title: p.tooltips.incrementSecond
            }).addClass("btn").attr("data-action", "incrementSeconds").append($("<i>").addClass(p.icons.up)))), 
            ...
            }).addClass("btn").attr("data-action", "decrementSeconds").append($("<i>").addClass(p.icons.down))))), 
        ...
        function t() {
            ...
            u() && o.append($("<li>").addClass(p.collapse && l() ? "collapse show" : "").append(r)), 
        ...
        function s() {
            ...
            if (u()) {
                for (s.eq(0).find("span").attr("title", p.tooltips.prevMonth), s.eq(1).attr("title", p.tooltips.selectMonth), 
                s.eq(2).find("span").attr("title", p.tooltips.nextMonth), o.find(".disabled").removeClass("disabled"), 
                s.eq(1).text(H.format(p.dayViewHeaderFormat)), h(H.clone().subtract(1, "M"), "M") || s.eq(0).addClass("disabled"), 
                h(H.clone().add(1, "M"), "M") || s.eq(2).addClass("disabled"), e = H.clone().startOf("M").startOf("w").startOf("d"), 
                a = 0; a < 42; a++) 0 === e.weekday() && (t = $("<tr>"), p.calendarWeeks && t.append('<td class="cw">' + e.week() + "</td>"), 
                d.push(t)), l = [ "day" ], e.isBefore(H, "M") && l.push("old"), e.isAfter(H, "M") && l.push("new"), 
                e.isSame(E, "d") && !W && l.push("active"), h(e, "d") || l.push("disabled"), e.isSame(c(), "d") && l.push("today"), 
                0 !== e.day() && 6 !== e.day() || l.push("weekend"), m({
                    type: "dp.classify",
                    date: e,
                    classNames: l
                }), t.append('<td data-action="selectDay" data-day="' + e.format("L") + '" class="' + l.join(" ") + '">' + e.date() + "</td>"), 
                e.add(1, "d");
                o.find("tbody").empty().append(d), n = N.find(".datepicker-months"), r = n.find("th"), 
                i = n.find("tbody").find("span"), r.eq(0).find("span").attr("title", p.tooltips.prevYear), 
                r.eq(1).attr("title", p.tooltips.selectYear), r.eq(2).find("span").attr("title", p.tooltips.nextYear), 
                n.find(".disabled").removeClass("disabled"), h(H.clone().subtract(1, "y"), "y") || r.eq(0).addClass("disabled"), 
                r.eq(1).text(H.year()), h(H.clone().add(1, "y"), "y") || r.eq(2).addClass("disabled"), 
                i.removeClass("active"), E.isSame(H, "y") && !W && i.eq(E.month()).addClass("active"), 
                i.each(function(e) {
                    ...
                    p.maxDate && p.maxDate.isBefore(n, "y") && t.eq(2).addClass("disabled"); !a.isAfter(n, "y"); ) r += '<span data-action="selectYear" class="year' + (a.isSame(E, "y") && !W ? " active" : "") + (h(a, "y") ? "" : " disabled") + '">' + a.year() + "</span>", 
                    a.add(1, "y");
                    e.find("td").html(r);
                }(), function() {
                    ...
                    d += '<span data-action="selectDecade" class="decade' + (E.isAfter(n) && E.year() <= e ? " active" : "") + (h(n, "y") || o || s ? "" : " disabled") + '" data-selection="' + (n.year() + 6) + '">' + (n.year() + 1) + " - " + (n.year() + 12) + "</span>", 
                    n.add(12, "y");
        ...
        function e() {
            ...
            e.text(E.format("A")), h(t, "h") ? e.removeClass("disabled") : e.addClass("disabled")), 
            ...
            a.filter("[data-time-component=seconds]").text(E.format("ss")), function() {
                ...
                a.push(n)), n.append('<td data-action="selectHour" class="hour' + (h(t, "h") ? "" : " disabled") + '">' + t.format(Y ? "HH" : "hh") + "</td>"), 
                t.add(1, "h");
                e.empty().append(a);
            }(), function() {
                ...
                a.push(n)), n.append('<td data-action="selectMinute" class="minute' + (h(t, "m") ? "" : " disabled") + '">' + t.format("mm") + "</td>"), 
                t.add(r, "m");
                e.empty().append(a);
            }(), function() {
                for (var e = N.find(".timepicker-seconds table"), t = H.clone().startOf("m"), a = [], n = $("<tr>"); H.isSame(t, "m"); ) t.second() % 20 == 0 && (n = $("<tr>"), 
                a.push(n)), n.append('<td data-action="selectSecond" class="second' + (h(t, "s") ? "" : " disabled") + '">' + t.format("ss") + "</td>"), 
                t.add(5, "s");
                e.empty().append(a);
            }();
        }
        ...
        function w(e) {
            ...
            h(e) ? (H = (E = e).clone(), I.val(E.format(q)), i.data("date", E.format(q)), W = !1, 
            y(), m({
                type: "dp.change",
                date: E.clone(),
                oldDate: t
        ...
        function b() {
            ...
            N.off("click", "[data-action]"), N.off("mousedown", !1), N.remove(), N = !1, m({
                type: "dp.hide",
                date: E.clone()
        ...
        function D() {
            var e;
            return I.prop("disabled") || !p.ignoreReadonly && I.prop("readonly") || N || (void 0 !== I.val() && 0 !== I.val().trim().length ? w(v(I.val().trim())) : W && p.useCurrent && (p.inline || I.is("input") && 0 === I.val().trim().length) && (e = c(), 
        ...
        function P() {
            ...
            d("y") && (V = 2), d("M") && (V = 1), d("d") && (V = 0), j = Math.max(V, j), W || w(E);
        }
        var E, H, I, Y, q, B, j, A, F, L = {}, W = !0, z = !1, N = !1, V = 0, Z = [ {
            ...
            selectMonth: function(e) {
                ...
                H.month(t), j === V ? (w(E.clone().year(H.year()).month(H.month())), p.inline || b()) : (o(-1), 
                s()), r("M");
            },
            selectYear: function(e) {
                var t = parseInt($(e.target).text(), 10) || 0;
                H.year(t), j === V ? (w(E.clone().year(H.year())), p.inline || b()) : (o(-1), s()), 
                r("YYYY");
            },
            ...
            selectDay: function(e) {
                ...
                w(t.date(parseInt($(e.target).text(), 10))), l() || p.keepOpen || p.inline || b();
            },
            ...
            togglePicker: function(e) {
                var t, a = $(e.target), n = a.closest("a"), r = a.closest("ul"), i = r.find(".show"), o = r.find(".collapse:not(.show)");
                if (i && i.length) {
                    if ((t = i.data("collapse")) && t.transitioning) return;
                    i.collapse ? (i.collapse("hide"), o.collapse("show")) : (i.removeClass("show"), 
                    o.addClass("show")), a.is("i") ? a.toggleClass(p.icons.time + " " + p.icons.date) : a.find("i").toggleClass(p.icons.time + " " + p.icons.date), 
            ...
            selectHour: function(e) {
                ...
                Y || (12 <= E.hours() ? 12 !== t && (t += 12) : 12 === t && (t = 0)), w(E.clone().hours(t)), 
                X.showPicker.call(L);
            },
        ...
        if (L.destroy = function() {
            ...
            return p.maxDate = t, p.useCurrent && !p.keepInvalid && E.isAfter(e) && w(p.maxDate), 
            ...
            return p.minDate = t, p.useCurrent && !p.keepInvalid && E.isBefore(e) && w(p.minDate), 
            ...
            return p.defaultDate = t, (p.defaultDate && p.inline || "" === I.val().trim()) && w(p.defaultDate), 
            L;
        }, L.locale = function(e) {
        ...
        if (i.hasClass("input-group") && (0 === i.find(".datepickerbutton").length ? 0 === (z = i.find(".input-group-text")).length && (z = i.find(".input-group-addon")) : z = i.find(".datepickerbutton")), 
        !p.inline && !I.is("input")) throw new Error("Could not initialize DateTimePicker without an input element");
        return E = c(), H = E.clone(), $.extend(!0, p, (A = {}, (F = i.is("input") || p.inline ? i.data() : i.find("input").data()).dateOptions && F.dateOptions instanceof Object && (A = $.extend(!0, A, F.dateOptions)), 
        $.each(p, function(e) {
