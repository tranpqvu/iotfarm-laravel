        ...
        var buttons="";
         if(this.options.buttons != undefined){
            if(this.options.buttons.length > 0){
                buttons += '<div class ="buttons-list btn-group col-lg-3 col-md-3 col-sm-3 col-xs-12" style="float:left">';
                $.each(this.options.buttons, function(ind, val){
                    if(val.name != undefined){
                        if(val.bclass != undefined){
                            if(val.onpress!=undefined){
                                buttons += '<span class="asi-bootgrid-button '+val.bclass+' btn btn-default" onclick="' + val.onpress +'()"><a href="javascript:void(0)">'+val.name+'</a></span>';
                            }else{
                                buttons += '<span class="asi-bootgrid-button btn btn-default '+val.bclass+'"><a href="javascript:void(0)">'+val.name+'</a></span>';
                            }
                        }else{
                            buttons += '<span class="asi-bootgrid-button btn btn-default"><a href="javascript:void(0)">'+val.name+'</a></span>';
                        }    
                    }
